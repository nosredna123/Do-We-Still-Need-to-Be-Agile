...
in the first cohort (2025.2) made no commits at all before their $T_1$
checkpoint, versus $0\%$ ($0/5$) in the second cohort (2026.1). Among the
nine teams with a scorable $T_1$ planning artifact, the mean Planning-Quality
Score (M6) is $3.56$ out of $10$ --- low even where planning text existed at
all.
