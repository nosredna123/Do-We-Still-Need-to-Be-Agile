...
Moreover, M8 can classify a $T_3$ change as rework only when the file existed
in an earlier window. Late-starting teams may therefore exhibit low measured
rework because their work is classified as deferred development or because
their total activity is low. We kept missing M6 scores distinct from observed
score 1 in the primary analysis and reported floor imputation as a sensitivity
analysis; its near-zero correlations show that the planning--rework association
is not robust to this defensible alternative operationalization.
