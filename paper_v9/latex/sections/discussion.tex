...
treatment. Current SDD guidance describes a workflow in which specifications
flow through technical planning, task decomposition, implementation, and
convergence checks~\cite{github2025spec,thoughtworks202Xspec}. That mechanism
matches the problem surfaced here: if GenAI makes implementation cheap while
system-level intent remains underspecified, a process that externalizes
intent, constraints, interfaces, and acceptance criteria may reduce ambiguity
before it is multiplied across generated code and parallel contributors.
...
summaries rather than a stable individual panel; RQ2 combines repository and
coverage-limited transcript evidence; RQ3 uses a 14 team-semester panel. These
limits support mechanism-oriented hypothesis generation, not causal estimates
of GenAI, planning, or SDD effects. The strongest conclusion is narrower:
under AI-assisted development, local generation speed does not eliminate the
need for explicit system-level coordination, and SDD is a plausible, testable
