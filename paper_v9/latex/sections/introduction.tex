...
Development (SDD), understood here as using an explicit specification as the
shared reference for planning, tasks, implementation, and checks, as a
theoretically grounded, testable hypothesis: carrying that specification
through technical planning, task decomposition, implementation, and convergence
checks may help teams address the coordination bottlenecks exposed by the
combined timing, planning, rework, complexity, and influence diagnostics
\cite{github2025spec,thoughtworks202Xspec}. This observational study neither
implemented SDD nor compared it with another development approach; therefore,
it does not establish SDD's effectiveness. Instead, the hypothesis invites
future intervention research into how teams can preserve adaptability while
ensuring that people and AI systems act on the same inspectable account of what
the system is meant to become.
