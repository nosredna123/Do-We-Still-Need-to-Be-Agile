...
uncertainty, and for good reason: in a world where typing and boilerplate were
the bottlenecks, minimizing upfront documentation minimized waste.
...
If deferring design in an AI-assisted environment merely relocates effort, the
result may be a collision between expectations of rapid AI-enabled productivity
and the realities of late-stage architectural integration. This paper examines
that possibility through repository metadata, multi-checkpoint student surveys,
independent evaluator scorecards, and qualitative meeting transcripts across two
cohorts of software-engineering projects. The resulting evidence connects what
students report, what repositories reveal, what evaluators score, and what
...
contrast between repository activity and integration pressure observable while
...
useful than a simple success/failure verdict: it shows where implementation
speed meets the harder problem of shared system intent.
...
remaining open to revision. Spec-Driven Development (SDD) is a promising way
to organize that layer by carrying a specification through technical planning,
task decomposition, implementation, and convergence checks
\cite{github2025spec,thoughtworks202Xspec}. We present SDD as a plausible,
testable response to the coordination pressure observed in AI-assisted work,
not as an intervention evaluated by this study. The empirical findings and the
proposition together invite a more precise question for future Agile practice:
how can teams preserve adaptability while ensuring that people and AI systems
act on the same inspectable account of what the system is meant to become?
