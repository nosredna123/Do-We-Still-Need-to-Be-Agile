...
| Threats to Validity | [x] | Added the missing explicit qualifications for exploratory M6b human-reviewed categories and overlapping rolling windows; confirmed the remaining canonical threats were already covered. | Existing proxy, causal, sample, grain, missingness, coverage, external-validity, and SDD boundaries retained. | PDF rebuilt; no fatal errors, undefined references, or overfull boxes; final coherence review completed. | Approved by user |
| Conclusion | [x] | Added the essential self-report qualifier to the contribution summary; no redundant Threats inventory was present and no structural rewrite was needed. | Contribution, bounded SDD proposition, future-testability statement, and causal boundary retained. | PDF rebuilt; no fatal errors, undefined references, or overfull boxes; final coherence review completed. | Approved by user |
| Introduction | [x] | Replaced the stronger SDD wording with a bounded plausible/testable formulation; no redundant threat inventory or structural change was needed. | Motivation, research gap, research questions, contributions, and future-practice framing retained. | PDF rebuilt; no fatal errors, undefined references, or overfull boxes; final coherence review completed. | Approved by user |
| Background and Related Work | [x] | Removed one duplicated section heading; no study-specific threat inventory or unsupported SDD efficacy claim required consolidation. | Literature qualifications, Agile context, research gap, and SDD as an open testable proposition retained. | PDF rebuilt; no fatal errors, undefined references, or overfull boxes; final coherence review completed. | Approved by user |
| Abstract | [x] | Consolidated redundant sensitivity wording, added the essential 2025.2 transcript-coverage qualifier, and changed SDD from "strong" to "plausible" and testable. | Design, principal findings, contribution, scope, baseline-conditioned results, and the single essential non-causal SDD qualifier retained. | PDF rebuilt after clearing stale generated auxiliaries; no fatal errors, undefined references, or overfull boxes; final coherence review completed. | Approved by user |
