...
- `pi_binary_event_count_t3`: n = 14, mean = 4.0, p-value = unavailable, coefficients = unavailable, missingness = 0.
- `pi_deleted_count_t3`: n = 14, mean = 12.857142857142858, p-value = unavailable, coefficients = unavailable, missingness = 0.
- `pi_file_count_t1`: n = 14, mean = 2.5714285714285716, p-value = unavailable, coefficients = unavailable, missingness = 0.
- `pi_line_delta_t1`: n = 14, mean = 60.142857142857146, p-value = unavailable, coefficients = unavailable, missingness = 0.
- `pi_line_delta_t3`: n = 14, mean = 10164.57142857143, p-value = unavailable, coefficients = unavailable, missingness = 0.
- `pi_renamed_count_t3`: n = 14, mean = 1.5714285714285714, p-value = unavailable, coefficients = unavailable, missingness = 0.
- `planning_artifact_activity_t3`: n = 14, mean = 89.28571428571429, p-value = unavailable, coefficients = unavailable, missingness = 0.
- `planning_rework_signal_t2_t3`: n = 14, mean = 163.64285714285714, p-value = unavailable, coefficients = unavailable, missingness = 0.
...
## Known limitations
- No inferential statistics are provided.
