## Group summary
The 'temporal_escalation' group measures the relationship between project scope, planning rework, and other temporal factors in software engineering. It aims to understand how changes over time can influence project outcomes and rework rates.

## Member artifacts
1. **scope_vs_pi_line_delta_t3**
   - **Status**: Supports
   - **Contribution**: Provides a robust global correlation indicating that changes in project scope are significantly related to performance metrics.
...
7. **late_instability_index__planning_rework_signal_t2_t3__top_bottom_4**
   - **Status**: Supports
   - **Contribution**: Provides exploratory group-level support for the relationship between late instability and planning rework.
...
9. **scope_vs_pi_line_delta_t3** (from leave-one-out sensitivity)
   - **Status**: Supports
   - **Contribution**: Confirms stability in the relationship between scope and performance metrics.

10. **scope_vs_planning_rework_t2_t3** (from leave-one-out sensitivity)
    - **Status**: Inconclusive
    - **Contribution**: Indicates fragile evidence regarding the relationship between scope and planning rework.
...
20. **scope_vs_pi_line_delta_t3** (from semester stratified results)
    - **Status**: Supports
    - **Contribution**: Provides contextual evidence for the relationship between scope and performance metrics.
...
23. **scope_vs_planning_rework_t2_t3** (from semester stratified results)
    - **Status**: Inconclusive
    - **Contribution**: Provides contextual evidence but requires careful interpretation.
