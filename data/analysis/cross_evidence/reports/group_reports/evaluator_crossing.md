## Group summary
The 'evaluator_crossing' group measures the relationships between various software engineering metrics, specifically focusing on the correlation between scope, planning artifact activity, commits per author, and late instability index. The group aims to provide insights into how these factors interact and influence project outcomes.

## Member artifacts
1. **scope_vs_planning_artifact_activity_t3**
   - **Status**: Supports
   - **Contribution**: Provides a robust correlation indicating that planning artifact activity is negatively associated with scope.
...
27. **scope_vs_late_instability_index** (duplicate)
    - **Status**: Inconclusive
    - **Contribution**: Requires contextualized interpretation.
